 ...
 */
@Entity
@Table(name = "TBL_ORG_STRUCTURE_TIER")
public class OrganizationalStructureTier implements Serializable{
    ...
    private String organizationalStructureID;
    ...
    public String getOrganizationalStructureID() {
        return organizationalStructureID;
    }

    public void setOrganizationalStructureID(String organizationalStructureID) {
